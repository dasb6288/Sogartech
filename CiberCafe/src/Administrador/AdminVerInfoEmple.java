...
public class AdminVerInfoEmple extends JFrame {
	...
	public AdminVerInfoEmple() {
		...
		JLabel lblInfoEmple = new JLabel("Informaci\u00F3n Empleados");
		lblInfoEmple.setHorizontalAlignment(SwingConstants.CENTER);
		lblInfoEmple.setForeground(Color.WHITE);
		lblInfoEmple.setFont(new Font("Bauhaus 93", Font.BOLD | Font.ITALIC, 35));
		lblInfoEmple.setBackground(Color.WHITE);
		lblInfoEmple.setBounds(10, 11, 804, 40);
		contentPane.add(lblInfoEmple);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"12345678A", "Empleado", "Apellido1 Apellido2", "654321987", "empleado@gmail.com", "06/05/2018", "Dependiente"},
				{"12345678A", "Empleado", "Apellido1 Apellido2", "654321987", "empleado@gmail.com", "06/05/2018", "T\u00E9cnico"},
				{"12345678A", "Empleado", "Apellido1 Apellido2", "654321987", "empleado@gmail.com", "06/05/2018", "Dependiente"},
				{"12345678A", "Empleado", "Apellido1 Apellido2", "654321987", "empleado@gmail.com", "06/05/2018", "T\u00E9cnico"},
			},
			new String[] {
				"DNI", "Nombre", "Apellidos", "Tel\u00E9fono", "Correo", "Fecha de alta", "Cargo"
			}
		));
